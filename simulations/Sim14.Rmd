...
```{r}
  ...
  aweights[,numnodes,1] <- c(0,-10,-5,  5, 10,0)
  aweights[,1,1] <- - c(0,-10,-5,  5, 10,0)
    input <- c(F,T,T,T,T,F)
  output <- !input
...
maxblockstosim <- 1000 ##this is just for debugging, so we can simulate fewer blocks but get 
