...
for(block in 1:numblocks)
{
 ...
 ##to be used later:   
  ...
  par(mfrow=c(3,3),mar=c(2,3,3,0))
  plotWeights(learn1$hweights,hframe,output,main="Original")
  plotWeights(learn2$hweights,hframe2,output,main="Add good")
  plotWeights(learn3$hweights,hframe3,output,main="Add bad")
  
  rng <- range((c(0,out$learningerror,learn2$learningerror,learn3$learningerror)))
